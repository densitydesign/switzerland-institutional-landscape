    ...
    this.draw = function(model) {
        ...
        legendItems = legendItems.enter()
            ...
            .html(function(d) {
                ...
                innerHtml = innerHtml.replace('Uncertain', 'Ungewiss').replace('Closed or not yet opened', 'Geschlossen oder noch nicht geöffnet').replace('Open but not included in directory', 'Offen aber nicht erfasst').replace('Open and included in directory', 'Offen und erfasst');
