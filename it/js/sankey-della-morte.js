    ...
    this.draw = function(model) {
        ...
        legendItems = legendItems.enter()
            ...
            .html(function(d) {
                ...
                innerHtml = innerHtml.replace('Uncertain', 'Ignoto').replace('Closed or not yet opened', 'Chiuso o non ancora aperto').replace('Open but not included in directory', 'Aperto, ma non rilevato').replace('Open and included in directory', 'Aperto e rilevato');
