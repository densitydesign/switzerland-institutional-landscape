function MapAll(id, swiss, data) {
    ...
    let categoriesList = {
        'capacity_group': ["0 - 19", "20 - 49", "50 - 99", "100 - 149", "150 - 199", "plus de 200", "pas d'indication"],
        'confession': ["protestant", "catholique", "interconfessionnel", "pas d'indication"],
        'accepted_gender': ["hommes", "femmes", "mixte", "pas d'indication"]
    }
        ...
        if (category !== undefined) {
            ...
            node = node.enter()
                ...
                .attr('stroke', function(d) {
                    if ((category === 'capacity_group' && d.capacity_group == "pas d'indication") || (category === 'confession' && d.confession == "pas d'indication") || (category === 'accepted_gender' && d.accepted_gender == "pas d'indication")) {
                        return '#074050';
                    }
                })
