...
function AcceptingInstitutions(id, data, swiss) {
    ...
    let notSpecifiedLabels = d3.scaleOrdinal()
        ...
        .range(["pas d'indication", 'Region-Nordwest-Innerschweiz', 'Region-Ostschweiz', "Choix-de-l'établissement-ou-de-l'home-selon-le-cas"])
            ...
            .on("click", function(d) {
                ...
                if (config.direction == 'from') {
                    ...
                    if (dataSelection.length > 0) {
                        ...
                        viz_message = thisCanton.properties.name + " n'a pas envoyé des personnes internées dans d'autres cantons en " + config.year + '.';
                    }
                    ...
                    if (dataSelection.length > 0) {
                        ...
                        viz_message = thisCanton.properties.name + " n'a pas reçu des personnes internées d'autres cantons en " + config.year + '.';
                    }
            ...
            node = node.enter()
                ...
                .attr('title', function(d) {
                    if (d.id.substring(0, 2) == 'XX') {
                        return `<div class="viz-tooltip"><span>Institution non spécifiée</span></div>`;
                    } else {
