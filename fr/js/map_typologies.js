function MapTypologies(id, swiss, data) {
    ...
    let categories = ["établissement de travail", "colonie pénitentiaire", "établissement d’éducation", "établissement pour alcooliques", "établissement pénitentiaire", "établissement psychiatrique", "hospice de pauvres", "établissement spécialisés"];
