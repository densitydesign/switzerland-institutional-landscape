    ...
    this.draw = function(model) {
        ...
        legendItems = legendItems.enter()
            ...
            .html(function(d) {
                ...
                innerHtml = innerHtml.replace('Uncertain', 'Incertain').replace('Closed or not yet opened', 'Fermé ou pas encore ouvert').replace('Open but not included in directory', 'Ouvert mais pas recensé').replace('Open and included in directory', 'Ouvert et recensé');
